            ...
            <section class="dnc-toolbar-wrap">
              <Row :gutter="16">
                ...
                <Col span="8" class="dnc-toolbar-btns">
                  ...
                  >添加行业信息</Button>
                  <ButtonGroup class="mr3">
                    <Button icon="md-refresh" title="刷新" @click="loadBusList"></Button>
                  </ButtonGroup>
                </Col>
              </Row>
            </section>
...
export default {
    ...
    return {
      ...
      formModel4: {
        ...
        buslist: {
          ...
          sources: {},
          columns: [
            { type: "selection", width: 50, key: "industryUuid" },
            {
              title: "行业名称",
              key: "industryName",
              minWidth: 100,
      ...
      stores: {
        ...
        contactPerson: {
          ...
          columns: [
            //选择框
            { type: "selection", width: 35, key: "industryUuid" },
            {
              title: "行业名称",
              key: "industryName",
              minWidth: 100,
  ...
  computed: {
    ...
    //删除
    selectRusRowsId() {
      return this.formModel4.selection.map(x => x.industryUuid);
    }
  },
  //方法集合
  methods: {
    //加载表格数据
    loadListAddress() {
      loadDataIndusy(this.formModel4.buslist.query).then(res => {
        console.log(res);
