...
using HaikanCRM.Api.RequestPayload.Rbac.Role;
    ...
    public class RoleController : ControllerBase
    {
        ...
        public IActionResult AssignPermission(RoleAssignPermissionPayload payload)
        {
            ...
            using (_dbContext)
            {
                ...
                //先删除当前角色原来已分配的权限
                _dbContext.Database.ExecuteSqlCommand("DELETE FROM SystemRolePermissionMapping WHERE systemroleuuid={0}", payload.RoleCode);
